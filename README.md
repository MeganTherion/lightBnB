...
Welcome to my LightBNB project! Here I've practiced using SQL to populate and query a database of properties.
You can log in, see your reservations, and add a property to the database.
